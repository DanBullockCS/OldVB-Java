...
Public Class Calculator
    ...
    '
    Private Sub btnOperator_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPlus.Click, btnMinus.Click, btnTimes.Click, btnDivide.Click, btnEqual.Click
