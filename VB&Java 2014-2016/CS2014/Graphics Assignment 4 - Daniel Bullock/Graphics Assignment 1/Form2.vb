Public Class Form2
    ...
    'Daniel Bullock | Quiz Form | Form 2 | Version #4
    ...
    Private Sub Form2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.lblSecurityLevelRemaining.Text = Form1.LifeCounter
    ...
    Private Sub lblAnswer1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lblAnswer1.Click
        ...
        If intAnswer = 1 Then
            ...
            Me.lblSecurityLevelRemaining.Text = Me.lblSecurityLevelRemaining.Text + 2
        Else
        ...
        If Me.lblSecurityLevelRemaining.Text <= 0 Then
            Application.Exit()
        End If
    ...
    Private Sub lblHelp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lblHelp.Click
        MessageBox.Show("Click on the answer to the question that you think is correct.") 'Little help button in the corner
    End Sub
